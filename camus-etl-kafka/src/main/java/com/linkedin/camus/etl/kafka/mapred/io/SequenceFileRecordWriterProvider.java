...
public class SequenceFileRecordWriterProvider implements RecordWriterProvider {
    ...
    private static Logger log = Logger
            .getLogger(SequenceFileRecordWriterProvider.class);
    ...
    public RecordWriter<IEtlKey, CamusWrapper<?>> getDataRecordWriter(
        ...
        if (recordDelimiter == null) {
            recordDelimiter = conf.get(ETL_OUTPUT_RECORD_DELIMITER,
        ...
        // Determine compression type (BLOCK or RECORD) and compression codec to
        // use.
        if (SequenceFileOutputFormat.getCompressOutput(context)) {
            ...
            Class<?> codecClass = SequenceFileOutputFormat
                    .getOutputCompressorClass(context, DefaultCodec.class);
